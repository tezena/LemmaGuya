  ...
  return (
    <div className="row   ">
      ...
      <div className="col-12 col-md-4 p-5 mt-5">
        <h3 className="mx-auto  fw-normal text-warning ">
        Final step, make the payment
              </h3>
              <p className=" text-start px-2 opacity-50 ">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Cras ornare ac eros congue ullamcorper. Fusce porta elementum euismod.
                  Curabitur venenatis mollis bibendum.</p>
        <form className="pb-5 position-relative">
        
         <MDBInput  className="mb-4 " id="" label="Card Number"  type="number"/>
   
          <MDBInput className="mb-4" type="password" id="" label="pasword" />
          <Dropdown className="mb-4">
            ...
            <Dropdown.Menu className="w-100  ">
              <Dropdown.Item href="#/action-1" variant=" transparent warning">CBEBirr</Dropdown.Item>
              <Dropdown.Item href="#/action-2">TeleBirr</Dropdown.Item>
              <Dropdown.Item href="#/action-3">Amole</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          <MDBInput
            label="Readonly"
